    ...
    <footer id="page-footer">
        ...
        <div class="bordersep"/>
            <div class="col-md-6 col-lg-6 col-xs-6 ">
                <h6 style={{textAlign: "center", fontWeight: "bold"}}> © 2019, Esh7en.com - <a  onClick={()=>{ReactRouter.goTo("/privacy")}} style={{cursor: 'pointer'}}>Privacy Policy  <span className="glyphicon glyphicon-briefcase"></span> </a> </h6>
            </div>
